...
public class WechatPayNotifyResponseProcessor implements HandlerMethodReturnValueHandler {
	...
	private WechatPayNotifyResponseXmlConverter converter = new WechatPayNotifyResponseXmlConverter();
	...
	public void handleReturnValue(Object returnValue, MethodParameter returnType, ModelAndViewContainer mavContainer, NativeWebRequest webRequest) throws Exception {
		...
		String xml = converter.toXML((WechatPayNotifyResponseEntity) returnValue);
